# -*- encoding: utf-8 -*-
# stub: pdf-reader 2.16.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/yob/pdf-reader/issues", "changelog_uri" => "https://github.com/yob/pdf-reader/blob/v2.16.0/CHANGELOG", "documentation_uri" => "https://www.rubydoc.info/gems/pdf-reader/2.16.0", "source_code_uri" => "https://github.com/yob/pdf-reader/tree/v2.16.0" } if s.respond_to? :metadata=
